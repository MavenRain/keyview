...
{
    public delegate void KeyStateChanged(uint vkCode, bool down, bool up);
    ...
    public static class Watcher
    {
        public static IDisposable Start(KeyStateChanged stateChanged)
        {
            ...
            var handle = UnsafeNativeMethods.SetWindowsHookEx(
                HookType.WH_KEYBOARD_LL, 
                delegate (int nCode, IntPtr wParam, KBDLLHOOKSTRUCT lParam) {
                    ctx.Post(x =>
                    {
            ...
            return new DisposeToken(handle);
        }
    }
    ...
    class DisposeToken : IDisposable 
    {
        ...
        internal DisposeToken(IntPtr handle) 
        {
            this.handle = handle;
        }
        ~DisposeToken() 
        ...
        void Dispose(bool disposing) 
        {
            ...
            {
                // stop watcher
                UnsafeNativeMethods.UnhookWindowsHookEx(this.handle);
